...
function AddMarkerConductor(data) {
    ...
    var infowindow = new google.maps.InfoWindow({
        content: `<strong>Equipo: ${conductor.equipo}
...
var cars_Ref = firebase.database().ref('/CURSO_DIGIT');


var dataConductores = firebase.database().ref('/CURSO_DIGIT');
